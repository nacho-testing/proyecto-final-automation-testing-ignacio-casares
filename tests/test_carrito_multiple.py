...
def test_carrito(driver, usuario_logueado, producto):
    ...
    try:
        ...
        print("Iniciando test del carrito para el producto: %s", nombre)
        ...
        print("Cantidad de productos encontrados en el catálogo: %d", cantidad_productos)
        ...
        print("Precio obtenido para '%s': %s", nombre, precio_del_producto)
        ...
        print("Agregando producto al carrito: %s", nombre)
        inventory_page.agregar_producto_por_nombre(nombre)

        print("Verificando que el contador del carrito se actualizó")
        contador_carrito = inventory_page.carrito_contador()
        print("Valor del contador del carrito: %d", contador_carrito)
        ...
        print("Verificando la lista de productos en el carrito")
        ...
        captura_de_pantalla(driver, 'test_carrito_multiple')
        raise e